...
def test_bradbury_project_creation():
    ...
    receipt = contract.create_project(
        args=[
            ...
            (
                ...
                "and public reads execute correctly against the Bradbury testnet runtime."
            ),
            "https://docs.genlayer.com/",
            "",
            10**18,
            int(time.time()) + 30 * 86_400,
            "Bradbury verification tranche",
            10**18,
    ...
    assert projects[-1]["title"] == "ProofFund Bradbury Verification"
